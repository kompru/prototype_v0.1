...
def main():
    ...
    secondary_products_input = input("Enter the names of secondary products separated by commas: ")
    original_secondary_products = re.split(",", secondary_products_input)  # Split by comma or newline
